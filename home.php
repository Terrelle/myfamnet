...
?>
                        ...
                        if ($_SESSION['admin'] == "1" or $_SESSION['admin'] == "2"){
                            ...
                            <li style='border-bottom: 1px solid gray;border-top: 1px solid gray;font-weight: bold;font-size: 15px;' class='dropdown-header'>".lang('adminOptions')."</li>

                        <a style='color: #CC0033; font-size: 19px; font-weight: bold; text-align: center;' href=\"".$dircheckPath."toacpnlp/?adb=General\"> ".lang('dashboard')."</a>
                            ";
                        }
                        ?>
...
<a href="<?php echo $dircheckPath; ?>logout"><p class="<?php echo lang('HLP_b'); ?>"><!--<img src="imgs/main_icons/1f4e4.png" />--> <?php echo lang('logout'); ?></p></a>
...
<!--========================[ Center col2 ]===============================-->
        <div align="left">
            ...
            <div id="AccountSetup">
            <div class="post">
                <p style="padding: 8px; color: #CC0033; font-size: 16px; border-bottom: 1px solid #ececec; margin: 10 15;text-align:<?php echo lang('textAlign') ?>;"><?php echo lang('accountSetup') ?></p>
                <!--==========[ Account Setup ]=========-->
                 <div class="aSetup" align="center">
                    <div class="aSetup_item">
                        ...
                        <?php if(!in_array('Userphoto', $aSetupVal)){ ?><a style="color: #CC0033;" href="u/<?php echo $_SESSION['Username'] ?>"><?php echo lang('complete') ?></a><?php } ?>
                    </div>
                    <div class="aSetup_item">
                        ...
                        <?php if(!in_array('uCoverPhoto', $aSetupVal)){ ?><a style="color: #CC0033;" href="u/<?php echo $_SESSION['Username'] ?>"><?php echo lang('complete') ?></a><?php } ?>
                    </div>
                    <div class="aSetup_item">
                        ...
                        <?php if(!in_array('CompleteInfo', $aSetupVal)){ ?><a style="color: #CC0033;" href="settings?tc=edit_profile"><?php echo lang('complete') ?></a><?php } ?>
                    </div>
                    <div class="aSetup_item">
                        <?php
                        $uid = $_SESSION['id'];
                        ...
                        <?php if(!in_array('followPeople', $aSetupVal)){ ?><a style="color: #CC0033;" href="search"><?php echo lang('complete') ?></a><?php } ?>
                    </div>
                </div>
