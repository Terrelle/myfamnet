...
?> <br/><a href="<?php echo './post?pid='.$saved_post_id; ?>" style="color: #CC0033;">Continue reading</a>
</div></div>
<div id="deleteSavedMsg_<?php echo $saved_id; ?>"></div>
</td>
<td align="center"><a  href="javascript:void(0);" onclick="deleteSavedMsg('<?php echo $saved_id; ?>');"><span class="fa fa-times" style="color: #CC0033; font-size: 18px;"></span></a></td>
</tr>
<?php
}
?>