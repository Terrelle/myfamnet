...
$lid = "";
    ...
    $unlike->execute();
    $likebtn =  "<span onclick=\"likeUnlike('$plike')\" style='color:#CC0033;font-size:30px' data-toggle='tooltip' data-placement='top' title='".lang('liked')."' id='plike'><span class=\"fa fa-heart-o\"></span></span>";
    ...
    if ($likes_num == 0) {
        ...
        $likenum = $likes_num." <span class='fa fa-heart' style='color: #CC0033;'></span>";
    }
    ...
    $like->execute();
    $likebtn = "<span onclick=\"likeUnlike('$plike')\" style='color:#CC0033;font-size:30px' data-toggle='tooltip' data-placement='top' title='".lang('u_liked_this')."' id='punlike'><span class=\"fa fa-heart\"></span></span>";
