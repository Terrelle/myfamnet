...
<div id="w_photo" class="wpost_tabcontent">
   <label>
       ...
       <div id='photo_preview' style="margin-top: 10px;order: 1px solid rgba(0, 0, 0, 0.1);overflow: hidden;width: 100px;height: 100px;border-radius:20px;display:none;position: relative;">
    ...
    <div id='photo_preview_box' style='cursor: pointer;display:block;width:100px;height:100px;border:20px;border-radius:20px;background-color: lightgray;text-align:center;'>
        <span class='fa fa-image' style='    margin: 35%;font-size: 30px;color: white;'></span>
         </div>
   </label>
</div>
