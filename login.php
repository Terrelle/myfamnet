...
<head>
    <title><? echo lang('login'); ?> | Myfamnet</title>
    <meta charset="UTF-8">
    <meta name="description" content="Myfamnet is a platform to share your interests with the people you care about.">
    <meta name="keywords" content="login,social network,social media,Myfamnet,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        ...
        <div align="center">
            <div class="login_signup_box" style="text-align:<? echo lang('textAlign'); ?>">
                <h4 style="font-size: 20px;" align="center"><? echo lang('login_now'); ?></h4><br/>
