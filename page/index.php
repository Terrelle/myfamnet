...
<div align="center" style="margin-top: 54px; padding: 3%;">
	<div align="left">
	<div class="contentBox" style="margin-bottom: 15px;"><p style="text-align:<?php echo lang('textAlign'); ?>;margin: 0px;padding: 10px 15px;"><span style="padding: 10px 15px;border-bottom: 3px solid #CC0033;"><?php echo lang('supportBox'); ?></span></p></div>
		...
		while ($r_row = $getReports->fetch(PDO::FETCH_ASSOC)) {
			...
			switch ($r_type) {
				case 'post':
					$subject = lang('you_anonymously_reported_a')." <a style='color:#CC0033;' href='../posts/post?pid=$for_id'>".lang('post')."</a>.";
					$report = lang('you_anonymously_reported_a')." <a style='color:#CC0033;' href='../posts/post?pid=$for_id'>".lang('post')."</a>.";
				break;
				case 'problem':
					$subject = $subject;
					$report = $report;
		...
		<div class="contentBox" id="report_<?php echo $r_id; ?>" style="width: 500px;margin-bottom: 15px;">
			<div id="viewreport" onclick="viewreport('<?php echo $r_id; ?>')">
				...
				<span style="color: #CC0033;font-size: 11px;"><?php echo lang('click_to_view_your_report'); ?></span></p></div>
			</div>
			<div id="myReport_<?php echo $r_id; ?>" style="display: none; background: #f6f7f9; border-bottom: 1px solid #ddd;">
				...
				<div style="padding: 5px;">
					...
					<p id="delR_<?php echo $r_id; ?>"><a style='color:#CC0033;' href="javascript:void(0);" onclick="deleteReport('<?php echo $r_id; ?>')"><?php echo lang('delete'); ?></a></p>
				</div>
				</div>
			</div> 
