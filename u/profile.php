...
<head>
    <title><?php echo $row_username; ?></title>
    <meta charset="UTF-8">
...
<!--=============================[ Container ]=====================================-->
        ...
        <div class="profile_picture">
            <h3 style="margin-top:30px; "><?php echo "<a style='color:gray;text-decoration: none;' href='".$row_username."'>$row_fullname</a>"; if ($row_verify == "1"){echo $verifyUser;} ?></h3>
        ...
        <div class="user_info">
            ...
            if (!empty($row_work0) || !empty($row_work)){echo "<tr><td class='user_info_tdi'><i class=\"fa fa-briefcase\"></i></td><td> $row_work0 ".lang('at')." $row_work<td></tr>";}
            if (!empty($row_country)){echo "<tr><td class='user_info_tdi'><i class=\"fa fa-map-marker\"></i></td><td> $row_country<td></tr>";}
